...
namespace Hex
{
    public class HexGenerater : MonoBehaviour
    {
        ...
        {
            tileCodes.Add((int)TileType.plain);
                ...
                for (int j = 1; j <= i * 6; j++)
                {
                    ...
                    else if (i < radius - 1)
                    {
                        if (rand > 60)
                            ...
                            tileCodes.Add((int)TileType.forest);
                        else
                            tileCodes.Add((int)TileType.lake);
                    }
                    else if (i == radius - 1)
                        tileCodes.Add((int)TileType.beach);
                    else
                        tileCodes.Add((int)TileType.sea);
                }
            }
        }
        ...
        private float SetTileHeight(int rad, int code)
        {
            ...
            else if (code == (int) TileType.lake)
                return -0.05f;
